...
*This page is a swagger ui screens that displays the interactive FastAPI endpoints. The `POST /admin/generate_data` endpoint is the gateway to creating your initial database.*


### ️How to Generate Initial Data
